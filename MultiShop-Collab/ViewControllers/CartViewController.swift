...
extension CartViewController {
    ...
    func setupData(){
        for index in 0...productImages.count - 1 {
            let productDetails = Cart(productName: productName[index], productImage: productImages[index], productQuantity: productQuantity[index], productStatus: productStatus[index], productPrice: productPrice[index])
